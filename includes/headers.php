...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo $includes_url . $CssStyle; ?>.css"
        type="text/css" />
</head>
...
<body>
        ...
        <div class="intro container">
            <div class="quick-search">
                <form name="fullsearch" method="GET" action="fullsearch.php">
                    ...
                    <input onfocus="if(this.value == 'Quick Search...') { this.value = ''; }"
                        ...
                        name="iname" placeholder="Quick Search..." type="text">
                </form>
            </div>
            <div class="logo">
                <a href="<?php echo $root_url; ?>"
                    title="Home"><?php echo $PageTitle; ?></a>
            </div>
        </div>
    ...
    <div id="main">
        ...
        <h2 class="page_title"><?php echo $Title; ?>
        </h2>